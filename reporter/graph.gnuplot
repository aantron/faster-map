...
plot source using 1:3 with lines ls 1 title "naive tail-rec.", \
     source using 1:9 with linespoints ls 1 pt 4 title "stdlib", \
     source using 1:10 with linespoints ls 1 pt 10 title "unrolled 5×", \
     source using 1:5 with lines ls 3 title "batteries", \
     source using 1:4 with lines ls 2 title "base", \
     source using 1:6 with lines ls 2 title "containers", \
